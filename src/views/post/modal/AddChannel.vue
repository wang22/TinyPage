...
export default {
  data () {
    return {
      ...
      visiableSelected: ['public', 'member', 'paid', 'private'],
      switches: {
        memberVisiable: [
          { text: 'Public', value: 'public' },
          { text: 'Member only', value: 'member', disabled: false },
          { text: 'Paid member only', value: 'paid', disabled: false },
          { text: 'Private', value: 'private', disabled: false }
        ]
      },
      channel: {
        name: '',
